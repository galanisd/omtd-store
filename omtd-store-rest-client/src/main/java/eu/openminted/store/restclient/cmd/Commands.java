...
public class Commands {
	...
	public final static String setEndpoint = "setEndpoint";
	public final static String printEndpoint = "printEndpoint";
	...
	public final static String finalizeArch = "finalizeArch";
	public final static String uploadFileToArch = "uploadFileToArch";
