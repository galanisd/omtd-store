...
import gr.grnet.escience.pithos.rest.PithosRequest;
import gr.grnet.escience.pithos.rest.PithosResponse;
import gr.grnet.escience.pithos.rest.PithosResponseFormat;
import gr.grnet.escience.pithos.rest.PithosResponseHashmap;
...
public class HadoopPithosConnector extends PithosRESTAPI implements
    ...
    public String getFileList(String pithosContainer) {
        ...
        System.out.println(this.getPithosRequest().getRequestHeaders());
        System.out.println(this.getPithosRequest().getRequestParameters());
        // - Read meta-data and add the data on the Pithos Response
        try {
